...
enum L10n {
    ...
    enum PillCount {
        ...
        static let confirmResetTitle = NSLocalizedString("pillCount.confirmResetTitle", comment: "")
        static let confirmResetMessage = NSLocalizedString("pillCount.confirmResetMessage", comment: "")
    ...
    enum Settings {
        ...
        static let connectionInfo = NSLocalizedString("settings.connectionInfo", comment: "")
        static let connectionInfoScreenTitle = NSLocalizedString("settings.connectionInfoScreenTitle", comment: "")
        static let deviceSectionTitle = NSLocalizedString("settings.deviceSectionTitle", comment: "")
        static let deviceIpAddressLabel = NSLocalizedString("settings.deviceIpAddressLabel", comment: "")
        static let deviceListenerPortLabel = NSLocalizedString("settings.deviceListenerPortLabel", comment: "")
        static let pmsSectionTitle = NSLocalizedString("settings.pmsSectionTitle", comment: "")
        static let pmsIpAddressLabel = NSLocalizedString("settings.pmsIpAddressLabel", comment: "")
        static let pmsPortLabel = NSLocalizedString("settings.pmsPortLabel", comment: "")
        static let ipAddressUnavailable = NSLocalizedString("settings.ipAddressUnavailable", comment: "")
        static let testConnection = NSLocalizedString("settings.testConnection", comment: "")
    ...
    enum FaceAuth {
        ...
        static let spokenPoseTurnLeft = NSLocalizedString("faceAuth.spokenPoseTurnLeft", comment: "")
        static let spokenPoseTurnRight = NSLocalizedString("faceAuth.spokenPoseTurnRight", comment: "")
        static let spokenEnrollmentComplete = NSLocalizedString("faceAuth.spokenEnrollmentComplete", comment: "")
