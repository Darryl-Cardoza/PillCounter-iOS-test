    ...
    func updateUserProfile(pharmacyTypeCode: String?, countryCode: String? = nil, stateCode: String? = nil) async {
        ...
        do {
            ...
            let request = UpdateUserProfileRequest(
                ...
                country: (countryCode ?? "") != (AppStorageManager.shared.selectedCountryCode ?? "") ? countryCode : nil,
                state: (stateCode ?? "") != (AppStorageManager.shared.selectedStateCode ?? "") ? stateCode : nil
            )
